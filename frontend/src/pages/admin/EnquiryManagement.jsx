...
export default function EnquiryManagement() {
  ...
  const openEdit = (e) => {
    ...
    setForm({
      ...
      interestedCourse: e.interestedCourse?._id || '',
      expectedAdmissionDate: e.expectedAdmissionDate
        ? e.expectedAdmissionDate.split('T')[0]
        : '',
  ...
  const downloadEnquiry = async (e) => {
    try {
      ...
      showAlert('error', 'Failed to download enquiry PDF')
    }
  }
                  ...
                  {paginated.map((e) => (
                    <tr key={e._id}>
                      ...
                      <td data-label="Status">
                        <span
                          className={`badge ${e.status === 'new' ? 'badge-info' : 'badge-warning'}`}
                        >
