...
export default function EnquiryManagement() {
  ...
  const downloadEnquiry = async (e) => {
    try {
      const response = await api.get(`/enquiries/${e._id}/pdf`, { responseType: 'blob' });
              ...
              <div className="modal-body">
                <div className="form-grid">
                  ...
                  <div className="form-group">
                    ...
                    <input className={`form-input ${errors.lastName ? 'error' : ''}`} placeholder="Surname" value={form.lastName} onChange={e => setForm({...form, lastName: e.target.value})} />
